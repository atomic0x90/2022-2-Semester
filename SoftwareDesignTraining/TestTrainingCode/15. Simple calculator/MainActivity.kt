package com.example.test1023_1_15
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnAdd.setOnTouchListener{
            view, motionEvent->
            num1 = edit1.getText().toString()
            num2 = edit2.getText().toString()
            result = num1.toDouble()+num2.toDouble()//Integer.parseInt(num1)+Integer.parseInt(num2)
        ...
        var sw:Switch = findViewById<Switch>(R.id.switch1)
        sw.setOnCheckedChangeListener{comp,b->
            if(b){
